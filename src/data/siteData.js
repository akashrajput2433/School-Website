export const siteConfig = {
  ...
  navItems: [
    ...
    { label: "Silent Features", href: "#features" },
    { label: "Academic Zone", href: "#academics" },
    { label: "Staff", href: "#staff" },
    { label: "School Toppers", href: "#toppers" },
    { label: "Notice Board", href: "#notices" },
    { label: "Mandatory Docs", href: "#docs" },
  ...
  home: {
    admission: {
      ...
      description:
        "Give your child a confident start with English medium learning, caring teachers, safe campus facilities, and activity-based education from Pre-Nursery to Class 8.",
      primaryCta: "Apply for Admission",
      secondaryCta: "Explore Campus"
    },
    principalMessage: {
      name: "Principal's Desk",
      designation: "S.D. Public & Convent School",
      message:
    ...
    notices: [
      {
        ...
        date: "May 2026",
        description:
          "Admissions are open from Pre-Nursery to Class 8. Parents can contact the school office for details."
      },
      {
        tag: "Academics",
        title: "New Academic Planning Underway",
        date: "Upcoming",
        description:
          "Class-wise curriculum planning, assignments, and activity schedules will be shared through the school notice board."
      },
      {
        tag: "Campus",
